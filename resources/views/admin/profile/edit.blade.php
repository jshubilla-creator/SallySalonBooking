<x-admin-layout>
                        ...
                        <form method="post" action="{{ route('admin.profile.update') }}" class="space-y-6" enctype="multipart/form-data">
                            ...
                            <div>
                                ...
                                <textarea name="address"
                                          id="address"
                                          rows="3"
                                          class="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-purple-500 @error('address') border-red-500 @enderror">{{ old('address', $user->address) }}</textarea>
                                @error('address')
                                    <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                                @enderror
                            </div>
                        ...
                        <form method="post" action="{{ route('admin.profile.password') }}" class="space-y-6">
                            ...
                            <div>
                                ...
                                <input type="password"
                                       ...
                                       id="current_password"
                                       class="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-purple-500 @error('current_password') border-red-500 @enderror"
                                       required>
                            ...
                            <div>
                                ...
                                <div class="flex space-x-2">
                                    <input type="text"
                                           ...
                                           class="flex-1 px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-purple-500 @error('two_factor_code') border-red-500 @enderror"
                                           placeholder="Enter 6-digit code"
                                           maxlength="6"
                                           required>
                                    <button type="button" onclick="sendPasswordCode()" class="px-4 py-2 bg-blue-600 text-white rounded-md hover:bg-blue-700">Send Code</button>
                                </div>
                            ...
                            <div>
                                ...
                                <div class="flex space-x-2">
                                    <input type="text"
                                           ...
                                           maxlength="6"
                                           required>
                                    <button type="button" onclick="sendDeleteCode()" class="px-4 py-2 bg-blue-600 text-white rounded-md hover:bg-blue-700">Send Code</button>
                                </div>
                                @error('two_factor_code')
                                    <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                                @enderror
    ...
    <script>
        ...
        function sendPasswordCode() {
            fetch('{{ route('admin.profile.send-2fa-code') }}', {
                method: 'POST',
                headers: {
