    ...
    <div class="py-6">
        <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="bg-gradient-to-br from-pink-100 via-purple-50 to-indigo-100 rounded-lg shadow-md border border-gray-200">
                ...
                <div class="p-6">
                    <form method="POST" action="{{ route('admin.staff.update-specialist', $specialist) }}" class="space-y-6">
                        @csrf
                        @method('PUT')
                        ...
                        <div>
                            ...
                            <textarea name="bio"
                                      ...
                                      class="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-purple-500 @error('bio') border-red-500 @enderror">{{ old('bio', $specialist->bio) }}</textarea>
                            @error('bio')
                                <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                            @enderror
                        </div>
                        ...
                        <div>
                            ...
                            <div class="flex items-center">
                                ...
                                <label for="is_available" class="ml-2 text-sm text-gray-700">Currently available for appointments</label>
                            </div>
                            @error('is_available')
                                <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                            @enderror
                        ...
                        <div>
                            ...
                            <div class="space-y-3">
                                @php
                                    ...
                                    $workingHours = old('working_hours', $specialist->working_hours ?? []);
                                @endphp
