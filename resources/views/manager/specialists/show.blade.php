        ...
        <div class="lg:col-span-2">
            ...
            <div class="mt-6 bg-gradient-to-br from-pink-100 via-purple-50 to-indigo-100 shadow rounded-lg">
                <div class="px-4 py-5 sm:p-6">
                    ...
                    <div class="space-y-2">
                        @php
                            $hasWorkingHours = $specialist->working_hours && count(array_filter($specialist->working_hours, fn($h) => isset($h['enabled']) && $h['enabled'])) > 0;
                        @endphp
                        
                        @if(!$hasWorkingHours)
                            <p class="text-sm text-gray-500 italic mb-4">No working hours configured. Please edit this specialist to set availability.</p>
                        @endif
                ...
                <div class="mt-6 bg-gradient-to-br from-pink-100 via-purple-50 to-indigo-100 shadow rounded-lg">
                    <div class="px-4 py-5 sm:p-6">
                        ...
                        @if($specialist->appointments->count() > 5)
                            <div class="mt-6">
                                <a href="{{ route('manager.appointments.index') }}?specialist_id={{ $specialist->id }}"
                                   class="w-full flex justify-center items-center px-4 py-2 border border-gray-300 shadow-sm text-sm font-medium rounded-md text-gray-700 bg-pink-100 hover:bg-gray-50">
                ...
                <div class="px-4 py-5 sm:p-6">
                    <h3 class="text-lg leading-6 font-medium text-gray-900 mb-4">Statistics</h3>
                        ...
                        <div class="flex justify-between">
                            ...
                            <span class="text-sm font-medium text-gray-900">{{ $specialist->appointments_count ?? $specialist->appointments->count() }}</span>
                        </div>
                        <div class="flex justify-between">
