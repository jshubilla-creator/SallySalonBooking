...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <body class="font-['Inter'] antialiased">
        ...
        <!-- Hero Section -->
        <div class="relative min-h-screen bg-gradient-to-br from-pink-100 via-purple-50 to-indigo-100" x-data="{ sidebarOpen: $persist(true) }">
        ...
        <div class="min-h-screen flex" >
            <!-- Sidebar -->
            <div class="hidden md:flex md:flex-col transition-all duration-300" :class="sidebarOpen ? 'md:w-64' : 'md:w-20'">
                <div class="flex flex-col flex-grow pt-5 bg-gradient-to-br from-pink-100 via-purple-50 to-indigo-100 overflow-y-auto shadow-lg">
                    ...
                    <div class="mt-5 flex-grow flex flex-col">
                        <nav class="flex-1 px-2 pb-4 space-y-1">
                            <!-- Dashboard -->
                            <a href="{{ route('manager.dashboard') }}"
                               class="group flex items-center px-2 py-2 text-sm font-medium rounded-md {{ request()->routeIs('manager.dashboard') ? 'bg-pink-100 text-green-900' : 'text-gray-600 hover:bg-gray-50 hover:text-gray-900' }}" :class="sidebarOpen ? '' : 'justify-center'">
                            ...
                            <a href="{{ route('manager.appointments.index') }}"
                               class="group flex items-center px-2 py-2 text-sm font-medium rounded-md {{ request()->routeIs('manager.appointments.*') ? 'bg-pink-100 text-green-900' : 'text-gray-600 hover:bg-gray-50 hover:text-gray-900' }}" :class="sidebarOpen ? '' : 'justify-center'">
                                <svg class="h-6 w-6" :class="sidebarOpen ? 'mr-3' : ''" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            ...
                            <a href="{{ route('manager.services.index') }}"
                               class="group flex items-center px-2 py-2 text-sm font-medium rounded-md {{ request()->routeIs('manager.services.*') ? 'bg-pink-100 text-green-900' : 'text-gray-600 hover:bg-gray-50 hover:text-gray-900' }}" :class="sidebarOpen ? '' : 'justify-center'">
                                <svg class="h-6 w-6" :class="sidebarOpen ? 'mr-3' : ''" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            ...
                            class="group flex items-center px-2 py-2 text-sm font-medium rounded-md {{ request()->routeIs('manager.payments.*') ? 'bg-pink-100 text-green-900' : 'text-gray-600 hover:bg-gray-50 hover:text-gray-900' }}" :class="sidebarOpen ? '' : 'justify-center'">
                                <svg class="h-6 w-6" :class="sidebarOpen ? 'mr-3' : ''" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            ...
                            <a href="{{ route('manager.specialists.index') }}"
                               class="group flex items-center px-2 py-2 text-sm font-medium rounded-md {{ request()->routeIs('manager.specialists.*') ? 'bg-pink-100 text-green-900' : 'text-gray-600 hover:bg-gray-50 hover:text-gray-900' }}" :class="sidebarOpen ? '' : 'justify-center'">
                                <svg class="h-6 w-6" :class="sidebarOpen ? 'mr-3' : ''" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M16 7a4 4 0 11-8 0 4 4 0 018 0zM12 14a7 7 0 00-7 7h14a7 7 0 00-7-7z"></path>
                                </svg>
                                <span x-show="sidebarOpen">Specialists</span>
                            </a>

                            <!-- Inventory -->
                            <a href="{{ route('manager.inventory.index') }}"
                               class="group flex items-center px-2 py-2 text-sm font-medium rounded-md {{ request()->routeIs('manager.inventory.*') ? 'bg-pink-100 text-green-900' : 'text-gray-600 hover:bg-gray-50 hover:text-gray-900' }}" :class="sidebarOpen ? '' : 'justify-center'">
                                <svg class="h-6 w-6" :class="sidebarOpen ? 'mr-3' : ''" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            ...
                            <a href="{{ route('manager.users.index') }}"
                               class="group flex items-center px-2 py-2 text-sm font-medium rounded-md {{ request()->routeIs('manager.users.*') ? 'bg-pink-100 text-green-900' : 'text-gray-600 hover:bg-gray-50 hover:text-gray-900' }}" :class="sidebarOpen ? '' : 'justify-center'">
                                <svg class="h-6 w-6" :class="sidebarOpen ? 'mr-3' : ''" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            ...
                            <a href="{{ route('manager.feedback.index') }}"
                               class="group flex items-center px-2 py-2 text-sm font-medium rounded-md {{ request()->routeIs('manager.feedback.*') ? 'bg-pink-100 text-green-900' : 'text-gray-600 hover:bg-gray-50 hover:text-gray-900' }}" :class="sidebarOpen ? '' : 'justify-center'">
                                <svg class="h-6 w-6" :class="sidebarOpen ? 'mr-3' : ''" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M7 8h10M7 12h4m1 8l-4-4H5a2 2 0 01-2-2V6a2 2 0 012-2h14a2 2 0 012 2v8a2 2 0 01-2 2h-3l-4 4z"></path>
                                </svg>
                                <span x-show="sidebarOpen">Feedback</span>
                            </a>
                            ...
                            <a href="{{ route('manager.settings') }}"
                               class="group flex items-center px-2 py-2 text-sm font-medium rounded-md {{ request()->routeIs('manager.settings') ? 'bg-pink-100 text-green-900' : 'text-gray-600 hover:bg-gray-50 hover:text-gray-900' }}" :class="sidebarOpen ? '' : 'justify-center'">
                                <svg class="h-6 w-6" :class="sidebarOpen ? 'mr-3' : ''" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <div class="flex flex-col flex-1 overflow-hidden">
                <!-- Top header -->
                <div class="relative z-10 flex-shrink-0 flex h-20 bg-gradient-to-r from-purple-600 via-pink-500 to-indigo-600 shadow-lg">
                    <div class="flex-1 px-4 flex justify-between items-center">
                        <div class="flex-1 flex items-center">
                            <h2 class="text-2xl font-bold text-white font-salon">Sally Salon Manager</h2>
                        </div>
                        <div class="ml-4 flex items-center md:ml-6 space-x-4">
                            ...
                            @auth
                                <div class="relative">
                                    <div>
                                        <button type="button" class="flex items-center space-x-3 px-4 py-2 rounded-lg bg-white bg-opacity-20 hover:bg-opacity-30 transition-all focus:outline-none focus:ring-2 focus:ring-white focus:ring-offset-2 focus:ring-offset-purple-600" id="user-menu-button">
                                    ...
                                    <div class="origin-top-right absolute right-0 mt-2 w-56 rounded-lg shadow-xl py-2 bg-white ring-1 ring-black ring-opacity-5 hidden" id="user-menu">
                                        <a href="{{ route('manager.profile.edit') }}" class="flex items-center px-4 py-3 text-sm text-gray-700 hover:bg-purple-50 transition-colors">
